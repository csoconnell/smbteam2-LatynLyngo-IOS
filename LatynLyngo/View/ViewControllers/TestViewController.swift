...
//  LatynLyngo
//
//  Created by NewAgeSMB on 30/03/21.
...
class TestViewController: UINavigationController {
    ...
    extension TestViewController: UIPickerViewDelegate {
        ...
        func loadPickerData(prefix1: String, prefix2 : String, root : String, suffix1:String, suffix2:String, suffix3:String, handler: (([DictionaryInfo])->Void)) {
            let movies: [DictionaryInfo] = DBManager.shared.loadMovieList(withDataWord: prefix1, prefix2: prefix2, root: root, suffix1: suffix1, suffix2: suffix2, suffix3: suffix3) ?? []
            if !movies.isEmpty {
